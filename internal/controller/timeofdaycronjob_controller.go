...
// +kubebuilder:rbac:groups=power.amdepyc.com,resources=timeofdaycronjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=power.amdepyc.com,resources=timeofdaycronjobs/status,verbs=get;update;patch
